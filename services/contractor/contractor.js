...
export const getcontractor = async (req, mainUserId, createdBy) => {
  ...
  if (postData.searchText) {
    // console.log("postdata.searchtext ===>",postData.searchText);
  ...
  let totalrecords = await dbService.recordsCount("contractorModel",where,{});
